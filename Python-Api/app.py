...
def ask_question():
    ...
    openai_endpoint = request.json.get('openai_endpoint')
    openai_key = request.json.get('openai_key')
    openai_apiversion = request.json.get('openai_apiversion')
    openai_llmdeployname = request.json.get('openai_llmdeployname')
    openai_embeddeployname = request.json.get('openai_embeddeployname')
    search_endpoint = request.json.get('search_endpoint')
    search_key = request.json.get('search_key')
    search_apiversion = request.json.get('search_apiversion')
